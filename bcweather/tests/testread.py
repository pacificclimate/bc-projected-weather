...
def adjust_wx_with_prism(wx_data,prism_diff):
    ...
    months = range(1,13)
    for mn in months:
        wx_data.dry_bulb_temperature[wx_data.month == mn] += round(prism_diff[mn-1],1)
    return(wx_data)
...
def prism_closest():
    ...
    write_epw_data(wx_offset, wx_header,"/home/ssobie/Desktop/weather_files/wx_files/test.epw")
